...
#crear una lista con 5 fruta. imprimir una fruta en cada linea usando un for
frutas = ["manzana", "platano", "fresa", "naranja", "kiwi"]
for fruta in frutas:
    print(fruta)
    #manzana
    #plátano
    ...
    #naranja
    #kiwi
#agrega un fruta al final de la lista , imprime la lista completa 
frutas.append("mango")
print(frutas)
...
frutas.sort()
print(frutas)
#ordenar de la palbra mas larga a la mas corta
